(function($) {
	...
	if( typeof tinymce != 'undefined' ){
	    tinymce.create('tinymce.plugins.classifieds', {
	        init : function(ed, url) {
	        	instance = ed;        	
				ed.addButton('classifiedsgrid', {
					type: 'listbox',
					text: 'Classifieds Grid',
					icon: false,
					onselect: function(e) {
				...
				/* elements */
				ed.addButton('classifiedselements', {
					type: 'listbox',
					text: 'Classifieds Elements',
					icon: false,
					onselect: function(e) {
						active_shortcode = this.value();
						call_shortcode();
					...
					values: [
						...
						{ text: 'Gallery', value: 'bg_gallery' },
						{ text: 'Gap', value: 'gap' },
						{ text: 'Icon', value: 'icon' },
						{ text: 'Iframe', value: 'iframe' },
						{ text: 'Label', value: 'label' },
						{ text: 'Pricings', value: 'pricings' },
	    ...
	    // Register plugin
	    tinymce.PluginManager.add( 'classifieds', tinymce.plugins.classifieds );
	}
})(jQuery);
