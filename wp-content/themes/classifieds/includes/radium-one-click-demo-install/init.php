...
if ( !class_exists( 'Radium_Theme_Demo_Data_Importer' ) ) {
	...
	require_once( get_template_directory().'/includes/radium-one-click-demo-install/importer/radium-importer.php' ); //load admin theme data importer
	...
	class Radium_Theme_Demo_Data_Importer extends Radium_Theme_Importer {
		 ...
		 * @var string
		 */
		public $theme_option_name       = 'classifieds_options'; //set theme options name here (key used to save theme options). Optiontree option name will be set automatically
		...
		public function __construct() {
			...
			$this->demo_files_path = get_template_directory().'/includes/radium-one-click-demo-install/demo-files/'; //can
