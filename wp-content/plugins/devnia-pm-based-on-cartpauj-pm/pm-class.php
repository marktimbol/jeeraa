...
/******************************************ADMIN SETTINGS PAGE BEGIN******************************************/
    ...
    function dispAdminPage()
    {
      ...
      echo 	"<div class='wrap'>
          ...
          <tr><td>".__("Max messages a user can keep in box? (0 = Unlimited)", "cartpaujpm")."<br /><small>".__("Admins always have Unlimited", "cartpaujpm")."</small></td><td><input class='form-control' type='text' size='10' name='num_messages' value='".$viewAdminOps['num_messages']."' /> ".__("Default","cartpaujpm").": 50</td></tr>
          <tr><td>".__("Messages to show per page", "cartpaujpm")."<br/><small>".__("Do not set this to 0!", "cartpaujpm")."</small></td><td><input class='form-control' type='text' size='10' name='messages_page' value='".$viewAdminOps['messages_page']."' /> ".__("Default","cartpaujpm").": 15</td></tr>" .
          ...
          "</small></td><td><input class='form-control' type='text' size='10' name='admin_user_login' value='" .
          ...
          "</small></td><td><input class='form-control' type='text' size='10' name='max_upload_size' value='" .
          ...
          <tr><td colspan='2'><span><input class='btn btn-primary' type='submit' name='pm-admin-save' value='".__("Save Options", "cartpaujpm")."' /></span></td></tr>
          </table>
          </form>
...
/******************************************USER SETTINGS PAGE BEGIN******************************************/
    function dispUserPage()
    {
      ...
      <input class='btn btn-primary' type='submit' name='pm-user-save' value='".__("Save Options", "cartpaujpm")."' />
      </form>";
      return $prefs;
    }
    ...
    function dispNewMsg()
    {
      ...
      if (!$this->isBoxFull($user_ID, $adminOps['num_messages'], '1'))
      {
        ...
        if (!$this->admin_user_id || $this->admin_user_id == $user_ID) {
          ...
          "<input class='form-control' type='text' id='search-q' onkeyup='javascript:autosuggest(\"" .
        ...
        <input type='text' class='form-control' name='message_title' maxlength='65' value='' /><br/>".
        __("Message", "cartpaujpm").":<br/>".$this->get_form_buttons()."<br/>
        <textarea class='form-control' name='message_content'></textarea>";
        // Attachment support.
        ...
        <input class='btn btn-primary' type='submit' onClick='this.disabled=true;this.form.submit();' value='".__("Send Message", "cartpaujpm")."' />
        </form>";
...
/******************************************READ MESSAGE PAGE BEGIN******************************************/
    function dispReadMsg()
    {
      ...
      <table class='table table-bordered'><tr><th width='15%'>".__("Sender", "cartpaujpm")."</th><th width='85%'>".__("Message", "cartpaujpm")."</th></tr>";
      ...
      <input type='submit' class='btn btn-primary' onClick='this.disabled=true;this.form.submit();' value='".__("Send Message", "cartpaujpm")."' />
      </form>";
...
/******************************************MESSAGE-BOX PAGE BEGIN******************************************/
    function dispMsgBox()
    {
      ...
      if ($numMsgs)
      {
        ...
        $msgsOut .= "<table class='table table-bordered'><tr>
...
/******************************************VIEW ANNOUNCEMENTS BEGIN******************************************/
    ...
    */
    ...
    function dispAnnounceForm()
    {
      ...
      <input type='text' class='form-control' name='message_title' value='' /><br/>".
      $this->get_form_buttons()."<br/>
      <textarea class='form-control' name='message_content'></textarea>
      <input type='hidden' name='message_date' value='".current_time('mysql', $gmt = 1)."' /><br/>
      <input type='submit' class='btn btn-primary' onClick='this.disabled=true;this.form.submit();' name='add-announcement' value='".__("Submit", "cartpaujpm")."' />
      </form>";
...
/******************************************MAIN DISPLAY BEGIN******************************************/
    ...
    function dispDirectory()
    {
      ...
      foreach($users as $u)
      {
        $directory .= '<p><strong>'.$u->user_login.'</strong> - <a href="'.$this->actionURL.'newmessage&to='.$u->ID.'">'.__('Send Message', 'cartpaujpm').'</a><i class="fa fa-envelope-o"></i></p>';
      }
      return $directory;
    }
